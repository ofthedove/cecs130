...
const char *CsVersionDate =  "10/24/13";	// Program compile date
...
void contactRandom(struct contactArray *);						// UI and functionality to show a random contact
																	...
																	// PARAMATERS: 
																	// RETURNS: 
void contactDeleteAll(struct contactArray *);					// UI and functionality to delete all contacts from contact book
																	// REQUIRES: 
																	// PARAMATERS: 
																	// RETURNS: 
	...
	while(1)											// Begin main program loop
	{
		...
		switch (menuSelect)								// Use switch to process additional user input values
		{
			...
			case 'v': case 'V': case '4':					// Not yet Implemented
				...
				break;
			case 's': case 'S': case '5':					// Case to delete all contacts
...
void contactDeleteAll(struct contactArray *contactBook)
{
