...
void playTTT();										// Contains the actual game code
void printGameInfo(bool, bool, bool, bool, int, int, int, int);	// Print info about the game, players and such. Goes above the game board
