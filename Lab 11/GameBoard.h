...
class GameBoard {					// Class to hold the game board and related functions
	...
	bool XPlayedLast;					// Did X make the last move or O?
  ...
  public:  
	...
	~GameBoard();						// Destructor
  	...
  	char checkMoveValid(int, int, int);		// Check if a spot on the board is already taken, returns true if spot is open
